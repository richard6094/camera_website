...
export default function Header({ cartCount = 0 }: HeaderProps) {
  ...
  return (
    <>
      {/* Fixed Header Bar */}
      <header 
        className={`fixed left-0 right-0 z-50 top-0 bg-[oklch(0.945_0.018_75/0.70)] backdrop-blur-md border-b border-foreground/10 transition-transform duration-300 ease-in-out ${
